...
let books = [
    ...
    { id: 'SNG', name: 'Cantar de los Cantares', chapters: [17, 17, 11, 16, 16, 13, 13, 14] },
...
const getChapters = async (book) => {
    ...
    for (chapterNo = 0; chapterNo < book.chapters.length; chapterNo++) {
...
const sequential = async (fn, isDone = false) => {
    ...
    const promise = await getChapters(book)
