export const VBL = {
    ...
    books: [
        ...
        { id: 'PSA', name: 'Salmos', chapters: [1, 6, 12, 8, 8, 12, 10, 17, 9, 20, 18, 7, 8, 6, 7, 5, 11, 15, 50, 14, 9, 13, 31, 6, 10, 22, 12, 14, 9, 11, 12, 24, 11, 22, 22, 28, 12, 40, 22, 13, 17, 13, 11, 5, 26, 17, 11, 9, 14, 20, 23, 19, 9, 6, 7, 23, 13, 11, 11, 17, 12, 8, 12, 11, 10, 13, 20, 7, 35, 36, 5, 24, 20, 28, 23, 10, 12, 20, 72, 13, 19, 16, 8, 18, 12, 13, 17, 7, 18, 52, 17, 16, 15, 5, 23, 11, 13, 12, 9, 9, 5, 8, 28, 22, 35, 45, 48, 43, 13, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 13, 10, 7, 12, 15, 21, 10, 20, 14, 9, 6] },
        ...
        { id: 'HOS', name: 'Oseas', chapters: [1, 11, 23, 5, 19, 15, 11, 16, 14, 17, 15, 11, 15, 16, 9] },
        { id: 'JOL', name: 'Joel', chapters: [1, 20, 32, 21] },
        { id: 'AMO', name: 'Amós', chapters: [1, 15, 16, 15, 13, 27, 14, 17, 14, 15] },
        { id: 'OBA', name: 'Abdías', chapters: [1, 21] },
        { id: 'JON', name: 'Jonás', chapters: [1, 16, 11, 10, 11] },
        { id: 'MIC', name: 'Miqueas', chapters: [1, 16, 13, 12, 13, 15, 16, 20] },
        { id: 'NAM', name: 'Nahúm', chapters: [1, 15, 13, 19] },
        { id: 'HAB', name: 'Habacuc', chapters: [1, 17, 20, 19] },
        { id: 'ZEP', name: 'Sofonías', chapters: [1, 18, 15, 20] },
        { id: 'HAG', name: 'Ageo', chapters: [1, 15, 23] },
        { id: 'ZEC', name: 'Zacarías', chapters: [1, 21, 13, 10, 14, 11, 15, 14, 23, 17, 12, 16, 14, 9, 21] },
        { id: 'MAL', name: 'Malaquías', chapters: [1, 14, 17, 18, 6] },
        { id: 'MAT', name: 'Mateo', chapters: [1, 25, 23, 17, 25, 48, 34, 29, 34, 38, 42, 30, 50, 58, 36, 39, 28, 27, 35, 30, 34, 46, 46, 39, 51, 46, 75, 66, 20] },
        { id: 'MRK', name: 'Marcos', chapters: [1, 45, 28, 35, 41, 43, 56, 37, 38, 50, 52, 33, 44, 37, 72, 47, 20] }, 
        { id: 'LUK', name: 'Lucas', chapters: [1, 80, 52, 38, 44, 39, 49, 50, 56, 62, 42, 54, 59, 35, 35, 32, 31, 37, 43, 48, 47, 38, 71, 56, 53] }, 
        { id: 'JHN', name: 'Juan', chapters: [1, 51, 25, 36, 54, 47, 71, 53, 59, 41, 42, 57, 50, 38, 31, 27, 33, 26, 40, 42, 31, 25] }, 
        { id: 'ACT', name: 'Hechos', chapters: [1, 26, 47, 26, 37, 42, 15, 60, 40, 43, 48, 30, 25, 52, 28, 41, 40, 34, 28, 40, 38, 40, 30, 35, 27, 27, 32, 44, 31] }, 
        { id: 'ROM', name: 'Romanos', chapters: [1, 32, 29, 31, 25, 21, 23, 25, 39, 33, 21, 36, 21, 14, 23, 33, 27] }, 
        { id: '1CO', name: '1 Corintios', chapters: [1, 31, 16, 23, 21, 13, 20, 40, 13, 27, 33, 34, 31, 13, 40, 58, 24] }, 
        { id: '2CO', name: '2 Corintios', chapters: [1, 24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 13] }, 
        { id: 'GAL', name: 'Gálatas', chapters: [1, 24, 21, 29, 31, 26, 18] }, 
        { id: 'EPH', name: 'Efesios', chapters: [1, 23, 22, 21, 32, 33, 24] }, 
        { id: 'PHP', name: 'Filipenses', chapters: [1, 30, 30, 21, 23] }, 
        { id: 'COL', name: 'Colosenses', chapters: [1, 29, 23, 25, 18] }, 
        { id: '1TH', name: '1 Tesalonicenses', chapters: [1, 10, 20, 13, 18, 28] }, 
        { id: '2TH', name: '2 Tesalonicenses', chapters: [1, 12, 17, 18] }, 
        { id: '1TI', name: '1 Timoteo', chapters: [1, 20, 15, 16, 16, 25, 21] }, 
        { id: '2TI', name: '2 Timoteo', chapters: [1, 18, 26, 17, 22] }, 
        { id: 'TIT', name: 'Tito', chapters: [1, 16, 15, 15] }, 
        { id: 'PHM', name: 'Filemón', chapters: [1, 25] }, 
        { id: 'HEB', name: 'Hebreos', chapters: [1, 14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29, 25] }, 
        { id: 'JAS', name: 'Santiago', chapters: [1, 27, 26, 18, 17, 20] }, 
        { id: '1PE', name: '1 Pedro', chapters: [1, 25, 25, 22, 19, 14] }, 
        { id: '2PE', name: '2 Pedro', chapters: [1, 21, 22, 18] }, 
        { id: '1JN', name: '1 Juan', chapters: [1, 10, 29, 24, 21, 21] }, 
        { id: '2JN', name: '2 Juan', chapters: [1, 13] }, 
        { id: '3JN', name: '3 Juan', chapters: [1, 15] },
        { id: 'JUD', name: 'Judas', chapters: [1, 25] }, 
        { id: 'REV', name: 'Apocalipsis', chapters: [1, 20, 29, 22, 11, 14, 17, 17, 13, 21, 11, 19, 17, 18, 20, 8, 21, 18, 24, 21, 15, 27, 21] }
    ]
}
